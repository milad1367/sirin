...
import {View,Text,StyleSheet,TouchableOpacity,Image,Dimensions,InteractionManager} from 'react-native';
...
export default class Store extends Component{
    ...
    render(){
        ...
        return(
        <View style={{flex : 1}}>
            <LinearGradient   colors={['#514a9d','#24c6dc']} style={{flexDirection : 'column',alignItems: 'stretch',flex:1,paddingTop : 30,paddingLeft:10,paddingRight:10,width : window.width,height : window.height}}>
                ...
                <View style={styles.toolbar}>
                    ...
                    <Text style={[styles.toolbarTitle,{ 
                        ...
                        color : '#fff',
                        justifyContent : 'center'},isFontLoaded && {fontFamily : 'Montserrat-Bold'}]}>Store</Text>
                    <View style={styles.toolbarButton}>
                ...
                <View style={{flex : 5,justifyContent : 'center',alignItems : 'center'}}>
                    <View style={{flexDirection : 'row',justifyContent : 'space-between',alignItems : 'center'}}>
                        <View style={{flex : 1,height : window.height*.25,justifyContent : 'center',alignItems : 'center',borderRadius : 10}}>
                            <Image source={require('../imgs/face.png')} style={{flex : 1,margin : 10,width : window.width*0.93,borderRadius : 10}}>
                                <View style={{flex : 1,backgroundColor : "rgba(0,0,0,0.5)",justifyContent : 'center',alignItems : 'flex-start',height : window.height*.20}}>
                                    <Text style={[{paddingTop : window.height*.1 , paddingHorizontal : 15,color : '#fff',textAlign : 'left',fontSize : window.width*.05},isFontLoaded && {fontFamily : 'Montserrat-Light'}]}>Nike Shoes</Text>          
                                </View>
                            </Image>
                        </View>    
                    </View>
                    <View style={{flexDirection : 'row',justifyContent : 'space-between',alignItems : 'center'}}>
                        <View style={{flex : 1,height : window.height*.25,justifyContent : 'center',alignItems : 'center',borderRadius : 10}}>
                            <Image source={require('../imgs/face.png')} style={{flex : 1,margin : 10,width : window.width*0.45,borderRadius : 10}}>
                                <View style={{flex : 1,backgroundColor : "rgba(0,0,0,0.5)",justifyContent : 'center',alignItems : 'flex-start',height : window.height*.20}}>
                                    <Text style={[{paddingTop : window.height*.1 , paddingHorizontal : 15,color : '#fff',textAlign : 'left',fontSize : window.width*.05},isFontLoaded && {fontFamily : 'Montserrat-Light'}]}>Nike Shoes</Text>          
                                </View>
                            </Image>
                ...
                <View style={{flex : 1,justifyContent : 'center',alignItems : 'center'}}>
                    <View style={{justifyContent : 'center',alignItems : 'center',}}>
                        <TouchableOpacity>
                            <LinearGradientButton detail="Shop Basket"/>
                        </TouchableOpacity>
                    </View>
                </View>
            </LinearGradient>
