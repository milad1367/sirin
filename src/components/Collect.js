...
class Collect extends Component {
  ...
  render() {
    ...
    return (
    <View style={{flex : 1}}>    
    <Captcha buttons = {['Wifi','Printer','Plane','Home']} index={Math.floor(Math.random() * 4)} show={this.state.modalShow} />    
            <View style={{flex : 1}}>
                <LinearGradient colors={['#514a9d','#24c6dc']} style={{flexDirection : 'column',alignItems: 'stretch',flex:1,paddingTop : 30,paddingLeft:10,paddingRight:10,width : window.width,height : window.height}}>
                    <Svg style={{zIndex : 0,position : 'absolute',top:window.height*0.25}} width={window.width} height={window.height} viewBox="0 0 750 689">
                    <G  id="#f7f7f7ff">
                    ...
                    <View style={styles.toolbar}>
                        ...
                        <Text style={[{ 
                            ...
                            color : '#fff',
                            justifyContent : 'center'},isFontLoaded && {fontFamily : 'Montserrat-Bold'}]}>Collect</Text>
                        <View style={styles.toolbarButton}>
                    ...
                    <View style={{justifyContent : 'center',alignItems : 'center',flex : 1}}>
                        <LinearGradient
                            ...
                            style={{paddingTop: window.width/50, alignItems: 'center', borderRadius: 15,height : window.height*.18,width : window.width*0.80,justifyContent : 'center'}}>
                            <View style={styles.toolbar}>
                                <Text style={[styles.toolbarTitle,{color : '#fff',margin : 10,fontSize : window.width * .07},isFontLoaded && {fontFamily : 'Montserrat-Light'}]}>You Have Only {"\n"} 
                                <Text style={[styles.toolbarTitle,{color : '#ffbc5e',margin : 10,fontSize : window.width * .075},isFontLoaded && {fontFamily : 'Montserrat-Light'}]}>21 Coins {"\n"}</Text>
                                </Text>
                            </View>
                        </LinearGradient>
                    </View>
                    <View style={{justifyContent : 'center',alignItems : 'center',flex : 1}}>
                        <TouchableOpacity onPress={()=>{this.setState({modalShow : true})}}>
                            <LinearGradientButton detail="Collect"/>
                        </TouchableOpacity>
                    </View>
