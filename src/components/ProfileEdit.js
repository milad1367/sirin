      ...
      <View style={{flex : 1}}>
        <View style={{flex : 10,justifyContent : 'center',alignItems : 'center'}}>
          <View style={[styles.toolbar,styles.formInfo,{flex : 2,justifyContent : 'center',alignItems : 'center'}]}>
            ...
            <TextInput underlineColorAndroid={'transparent'} multiline={true} placeholderTextColor="#51a9ce" placeholder="Alireza Shahabi" style={[{flex : 2,textAlign : 'right',paddingTop:5,paddingRight : width/30,color:'#51a9ce',fontSize : width/20},isFontLoaded && {fontFamily : 'Montserrat-Bold'}]}/>
          </View>
          <View style={[styles.toolbar,styles.formInfo,{flex : 2,justifyContent : 'center',alignItems : 'center'}]}>
              ...
              <TextInput keyboardType={'phone-pad'} underlineColorAndroid={'transparent'} multiline={true} placeholderTextColor="#51a9ce" placeholder="+989331497169" style={[{flex : 2,textAlign : 'right',paddingTop:5,paddingRight : width/30,color:'#51a9ce',fontSize : width/20},isFontLoaded && {fontFamily : 'Montserrat-Bold'}]}/>
          </View>
          <View style={[styles.toolbar,styles.formInfo,{flex : 2,justifyContent : 'center',alignItems : 'center'}]}>
              ...
              <TextInput underlineColorAndroid={'transparent'} multiline={true} placeholderTextColor="#51a9ce" placeholder="shahabvshahabi1996@gmail.com" style={[{flex : 2,textAlign : 'right',paddingTop:5,paddingRight : width/30,color:'#51a9ce',fontSize : width/28},isFontLoaded && {fontFamily : 'Montserrat-Bold'}]}/>
          </View>
        ...
        <View style={{flex : 1}}>
            <View style={{justifyContent : 'center',alignItems : 'center',flex : 3}}>
              <View style={[styles.toolbar,styles.formInfo,{flex : 1}]}>
                  ...
                  <Text style={[{flex : 2,textAlign : 'right',paddingRight : width/30,fontSize : width/25,color:'#51a9ce'},isFontLoaded && {fontFamily : 'Montserrat-Bold'}]}>Alireza Shahabi</Text>
              </View>
              <View style={[styles.toolbar,styles.formInfo,{flex : 1}]}>
                  ...
                  <Text style={[{flex : 1,textAlign : 'right',paddingRight : width/30,fontSize : width/25,color:'#51a9ce'},isFontLoaded && {fontFamily : 'Montserrat-Bold'}]}>+989331497169</Text>
              </View>
              <View style={[styles.toolbar,styles.formInfo,{flex : 1}]}>
                  ...
                  <Text style={[{flex : 4,textAlign : 'right',paddingRight : width/30,color:'#51a9ce',fontSize : width/25},isFontLoaded && {fontFamily : 'Montserrat-Bold'}]}>shahabvshahabi1996@gmail.com</Text>
              </View>
              <View style={[styles.toolbar,styles.formInfo,{flex : 1}]}>
                  ...
                  <Text style={[{flex : 2,textAlign : 'right',paddingRight : width/30,fontSize : width/25,color:'#51a9ce'},isFontLoaded && {fontFamily : 'Montserrat-Bold'}]}>31/01/1375</Text>
              </View>
            </View>  
            ...
            colors={['#514a9d','#24c6dc','#fcfdff','#f7f7f7','#fff']} style={{borderColor : this.state.borderColor,borderWidth : this.state.borderWidth,flexDirection : 'column',borderRadius : this.state.borderRadius,alignItems: 'stretch',flex:1,paddingTop : 30,paddingLeft:10,paddingRight:10,height : window.height , width : window.width}}>
              ...
              <View style={styles.toolbar}>
                ...
                <View style={[styles.toolbar,styles.imageContainer,{marginTop : window.width/20,marginBottom : window.width/20}]}>
                    <Image source={require('../imgs/face.png')} style={[styles.profileImage,{width : window.width/2.5 , height : window.width/2.5}]}></Image> 
                </View>
                {this.ProfileForm}  
            </LinearGradient>
